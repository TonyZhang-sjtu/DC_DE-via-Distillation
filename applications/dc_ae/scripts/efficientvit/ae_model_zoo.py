...
REGISTERED_DCAE_MODEL: dict[str, tuple[Callable, Optional[str]]] = {
    ...
    #################################################################################################
    "dc-ae-f32c32-in-1.0-pruned-v1": (dc_ae_f32c32, None),
    "dc-ae-f32c32-in-1.0-pruned-v2": (dc_ae_f32c32, None),
    "dc-ae-f32c32-in-1.0-pruned-v3": (dc_ae_f32c32, None),
    "dc-ae-f32c32-in-1.0-pruned-v4": (dc_ae_f32c32, None),
    "dc-ae-f32c32-in-1.0-pruned-v5": (dc_ae_f32c32, None),
    "dc-ae-f32c32-in-1.0-pruned-w3-v1": (dc_ae_f32c32, None),
    "dc-ae-f32c32-in-1.0-pruned-w3-v2": (dc_ae_f32c32, None),
    "dc-ae-f32c32-in-1.0-pruned-w4-v1": (dc_ae_f32c32, None),
    "dc-ae-f32c32-in-1.0-pruned-w4-v2": (dc_ae_f32c32, None),
    "dc-ae-f32c32-in-1.0-pruned-w4-v3": (dc_ae_f32c32, None),
    "dc-ae-f64c128-in-1.0-pruned-v1": (dc_ae_f64c128, None),
}
